...
export const SkillsView: React.FC<SkillsViewProps> = ({ onSelectSkill }) => {
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      {/* Hero Section */}
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-blue-900/40 via-indigo-950/30 to-purple-900/30 border border-border p-6 sm:p-8">
        <div className="max-w-3xl space-y-3">
          ...
          <h1 className="text-2xl sm:text-4xl font-extrabold tracking-tight text-foreground">
            Antigravity <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-400">Skills Catalog</span>
          </h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        <div
          ...
          className="glass-card p-4 rounded-2xl cursor-pointer hover:border-blue-500/50 group"
        >
          <div className="text-2xl mb-2">📋</div>
          <h4 className="text-xs font-bold text-foreground group-hover:text-blue-400 transition-colors">Need to Clarify or Plan?</h4>
        ...
        >
          ...
          <p className="text-[11px] text-muted-foreground mt-0.5">ponytail, karpathy-skills</p>
        </div>
        ...
        >
          ...
          <p className="text-[11px] text-muted-foreground mt-0.5">fleet-loop, tdd, verify.ps1</p>
        </div>
        ...
        >
          ...
          <p className="text-[11px] text-muted-foreground mt-0.5">security-sandbox, strix ai</p>
        </div>
      </div>
        ...
        {filteredSkills.map((skill) => (
          ...
          >
            ...
            <div>
              <div className="flex items-start justify-between gap-2 mb-3">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-bold text-foreground text-sm group-hover:text-blue-400 transition-colors">
                    {skill.name}
                  </h3>
                </div>
            ...
            <div className="pt-3 border-t border-border/60 flex items-center justify-between text-[11px]">
              ...
              <span className="flex items-center gap-1 text-blue-400 font-medium opacity-80 group-hover:opacity-100 transition-opacity">
                <span>Details</span>
